...
public class CalculadoraSubneting {
    ...
    public CalculadoraSubneting(int primerOct, int segundoOct, int tercerOct, int cuartoOct, 
                                 int prefijo, int cantSubRedes, String clase) {
        this.primerOct = primerOct;
        this.segundoOct = segundoOct;
        this.tercerOct = tercerOct;
        this.cuartoOct = cuartoOct;
        this.prefijo = prefijo;
        this.cantSubRedes = cantSubRedes;
        this.clase = clase;
        this.calcBin = new CalculadoraIp();
    }

    // Métodos existentes (sin cambios)
    public String[] getMascaraDecimal() {
        String mascaraDec[] = new String[4];
        String[] octetosMasc = calcBin.convertirPrefijoRedBinOctPorOct(prefijo);
        ...
        mascaraDec[2] = String.valueOf(calcBin.convertirBinarioDecimal(octetosMasc[2]));
        mascaraDec[3] = String.valueOf(calcBin.convertirBinarioDecimal(octetosMasc[3]));
        return mascaraDec;
    }
